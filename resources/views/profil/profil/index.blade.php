                            ...
                            <div class="col">
                                <div class="d-flex justify-content-center">
                                    <div class="d-grid text-center mx-4">
                                        <span class="text-lg font-weight-bolder">{{$totalpinjam}}</span>
                                        <span class="text-sm opacity-8">Pinjam Buku</span>
                                    </div>
                                    <div class="d-grid text-center">
                                        <span class="text-lg font-weight-bolder">{{ \App\Models\PinjamBuku::where('id_user', Auth::user()->id)->count() }}</span>
