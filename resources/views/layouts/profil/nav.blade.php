    ...
    <div class="container-fluid py-1 px-3">
        ...
        <div class="profile-menu">
            ...
            <div class="dropdown-content"
                style="width: 200px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 10px; overflow: hidden; background-color: #fff;">
                    ...
                    @if (Auth::check())
                        @if (Auth::user()->isAdmin)
                            <a href="{{ url('admin/dashboard') }}"
                                ...
                                <i class="bi bi-speedometer" style="margin-right: 10px;"></i> Admin Dashboard
                            </a>
                        @endif
                        <a href="{{ url('/') }}"
                            style="display: flex; align-items: center; text-decoration: none; color: #333; padding: 5px 0;">
                        ...
                        @else
                        <a class="nav-link text-dart" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="display: flex; align-items: center; text-decoration: none; color: #333; padding: 5px 0;">
