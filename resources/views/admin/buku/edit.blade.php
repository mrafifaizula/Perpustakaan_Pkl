                ...
                <div class="card-body">
                    <form action="{{route('buku.update', $buku->id)}}" method="post"
                        ...
                        <div class="mb-2">
                            ...
                            @if($buku->image_buku)
                            <p>
                                <image src="{{ asset('images/buku/' .$buku->image_buku)}}" alt="image_buku" width="100px">
                            </p>
                            @endif
                            <input type="file" name="image_buku" class="form-control @error('image_buku') is-invalid @enderror">
                            @error('image_buku')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('desc_buku') is-invalid @enderror"
                                name="desc_buku"></textarea>
                            @error('desc_buku')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
